sap.ui.define([
		...
		return BaseObject.extend("bootcamp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias bootcamp.model.ListSelector
			 */
			 ...
			 * @return {bootcamp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
