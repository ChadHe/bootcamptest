sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("bootcamp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("bootcamp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["bootcamp/localService/mockserver"], function (mockserver) {
